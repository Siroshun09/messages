...
/**
 * An interface to create {@link MiniMessageBase} from the 7 arguments.
 * 
...
public interface Arg7<A1, A2, A3, A4, A5, A6, A7> {
    ...
    /**
     * Creates {@link MiniMessageBase} from the 7 arguments.
     * 
    ...
    @NotNull MiniMessageBase apply(A1 a1, A2 a2, A3 a3, A4 a4, A5 a5, A6 a6, A7 a7);
