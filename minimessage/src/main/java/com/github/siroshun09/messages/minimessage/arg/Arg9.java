...
/**
 * An interface to create {@link MiniMessageBase} from the 9 arguments.
 * 
...
public interface Arg9<A1, A2, A3, A4, A5, A6, A7, A8, A9> {
    ...
    /**
     * Creates {@link MiniMessageBase} from the 9 arguments.
     * 
    ...
    @NotNull MiniMessageBase apply(A1 a1, A2 a2, A3 a3, A4 a4, A5 a5, A6 a6, A7 a7, A8 a8, A9 a9);
