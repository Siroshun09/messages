...
/**
 * An interface to create {@link LegacyFormatMessageBase} from the 8 arguments.
 * 
...
public interface Arg8<A1, A2, A3, A4, A5, A6, A7, A8> {
    ...
    static <A1, A2, A3, A4, A5, A6, A7, A8> @NotNull Arg8<A1, A2, A3, A4, A5, A6, A7, A8> arg8(@NotNull String key, @NotNull Function<? super A1, ? extends ReplacementBase> a1, @NotNull Function<? super A2, ? extends ReplacementBase> a2, @NotNull Function<? super A3, ? extends ReplacementBase> a3, @NotNull Function<? super A4, ? extends ReplacementBase> a4, @NotNull Function<? super A5, ? extends ReplacementBase> a5, @NotNull Function<? super A6, ? extends ReplacementBase> a6, @NotNull Function<? super A7, ? extends ReplacementBase> a7, @NotNull Function<? super A8, ? extends ReplacementBase> a8) {
    ...
    /**
     * Creates {@link LegacyFormatMessageBase} from the 8 arguments.
     * 
    ...
    @NotNull LegacyFormatMessageBase apply(A1 a1, A2 a2, A3 a3, A4 a4, A5 a5, A6 a6, A7 a7, A8 a8);
