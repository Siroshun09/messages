...
/**
 * An interface to create {@link LegacyFormatMessageBase} from the 9 arguments.
 * 
 ...
 */
@FunctionalInterface
public interface Arg9<A1, A2, A3, A4, A5, A6, A7, A8, A9> {

    /**
     * Creates {@link Arg9} from the message key and the functions.
     * 
     ...
     * @param <A8> the type of the 8th argument
     * @param <A9> the type of the 9th argument
     * @return a new {@link Arg9}
     */
    @Contract("_, _, _, _, _, _, _, _, _, _ -> new")
    static <A1, A2, A3, A4, A5, A6, A7, A8, A9> @NotNull Arg9<A1, A2, A3, A4, A5, A6, A7, A8, A9> arg9(@NotNull String key, @NotNull Function<? super A1, ? extends ReplacementBase> a1, @NotNull Function<? super A2, ? extends ReplacementBase> a2, @NotNull Function<? super A3, ? extends ReplacementBase> a3, @NotNull Function<? super A4, ? extends ReplacementBase> a4, @NotNull Function<? super A5, ? extends ReplacementBase> a5, @NotNull Function<? super A6, ? extends ReplacementBase> a6, @NotNull Function<? super A7, ? extends ReplacementBase> a7, @NotNull Function<? super A8, ? extends ReplacementBase> a8, @NotNull Function<? super A9, ? extends ReplacementBase> a9) {
        ...
        return new Arg9Impl<>(key, a1, a2, a3, a4, a5, a6, a7, a8, a9);
    }

    /**
     * Creates {@link LegacyFormatMessageBase} from the 9 arguments.
     * 
    ...
    @NotNull LegacyFormatMessageBase apply(A1 a1, A2 a2, A3 a3, A4 a4, A5 a5, A6 a6, A7 a7, A8 a8, A9 a9);
