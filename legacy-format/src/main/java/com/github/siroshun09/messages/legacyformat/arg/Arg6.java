...
/**
 * An interface to create {@link LegacyFormatMessageBase} from the 6 arguments.
 * 
...
public interface Arg6<A1, A2, A3, A4, A5, A6> {
    ...
    static <A1, A2, A3, A4, A5, A6> @NotNull Arg6<A1, A2, A3, A4, A5, A6> arg6(@NotNull String key, @NotNull Function<? super A1, ? extends ReplacementBase> a1, @NotNull Function<? super A2, ? extends ReplacementBase> a2, @NotNull Function<? super A3, ? extends ReplacementBase> a3, @NotNull Function<? super A4, ? extends ReplacementBase> a4, @NotNull Function<? super A5, ? extends ReplacementBase> a5, @NotNull Function<? super A6, ? extends ReplacementBase> a6) {
    ...
    /**
     * Creates {@link LegacyFormatMessageBase} from the 6 arguments.
     * 
    ...
    @NotNull LegacyFormatMessageBase apply(A1 a1, A2 a2, A3 a3, A4 a4, A5 a5, A6 a6);
