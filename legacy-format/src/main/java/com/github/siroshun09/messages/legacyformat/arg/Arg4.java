...
/**
 * An interface to create {@link LegacyFormatMessageBase} from the 4 arguments.
 * 
...
public interface Arg4<A1, A2, A3, A4> {
    ...
    static <A1, A2, A3, A4> @NotNull Arg4<A1, A2, A3, A4> arg4(@NotNull String key, @NotNull Function<? super A1, ? extends ReplacementBase> a1, @NotNull Function<? super A2, ? extends ReplacementBase> a2, @NotNull Function<? super A3, ? extends ReplacementBase> a3, @NotNull Function<? super A4, ? extends ReplacementBase> a4) {
    ...
    /**
     * Creates {@link LegacyFormatMessageBase} from the 4 arguments.
     * 
    ...
    @NotNull LegacyFormatMessageBase apply(A1 a1, A2 a2, A3 a3, A4 a4);
